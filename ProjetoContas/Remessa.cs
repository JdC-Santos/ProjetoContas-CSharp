...
namespace ProjetoContas
{
    class Remessa
    {
        ...
        public string Reg_id { get => reg_id.ToString(); set => reg_id = value.ToString(); }
        ...
        public string Reg_dgt_auto_conf_nr_banc {
            get => reg_dgt_auto_conf_nr_banc; set => reg_dgt_auto_conf_nr_banc = NossoNumero(value);
        }
        ...
        public string Reg_dt_venc_titulo {
        ...
        public string Reg_dt_lmt_conces_desc {
            get => reg_dt_lmt_conces_desc;
            set => reg_dt_lmt_conces_desc = FormataData(value); }
        ...
        public string Reg_inscr_pag { get => reg_inscr_pag; set => reg_inscr_pag = value; }
